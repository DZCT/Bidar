...
| 🎚 **Mixcloud** | مستقیم |
| 🎶 **Yandex Music** | مستقیم |
| 🟢 **Spotify** | استخراج خودکار اسم آهنگ + خواننده، سپس دانلود از یوتیوب |
| 🟣 **Deezer** | استخراج خودکار + دانلود از یوتیوب |
| 🍎 **Apple Music** | استخراج خودکار + دانلود از یوتیوب |
| 🌊 **Tidal** | استخراج خودکار + دانلود از یوتیوب |

> 💡 پلتفرم‌های دارای DRM (اسپاتیفای، دیزر و …) به‌دلیل محافظت قانونی فایل اصلی قابل دانلود نیستن. بیدار خودکار اسم و خواننده رو از لینک می‌گیره و معادلش رو از یوتیوب پیدا می‌کنه.
...
- 🚫 جلوگیری از دانلود تکراری (هر لینک یکتا در ۵ دقیقه فقط یک‌بار دانلود میشه)
